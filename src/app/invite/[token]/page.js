...
export default async function InviteProfilePage({ params }) {
  ...
  // If we reach here, it's either GENERAL or a VERIFIED SPECIFIC invite
  ...
  return (
    <main className="bg-[#F9FAFB] text-slate-950">
      <div className="bg-[#4F46E5] text-white py-2 text-center text-sm font-semibold">
        Viewing Portfolio via Recruiter Link
      </div>
